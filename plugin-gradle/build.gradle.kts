...
cleanUpCoverage {
  classes = listOf("com.diffplug.gradle.spotless.JavaExtension\$EclipseCleanUpConfig*")
  tests = listOf("com.diffplug.gradle.spotless.JavaEclipseCleanUpUnitTest*")
  // ProjectBuilder uses reflective access to Gradle/JDK internals, including in PIT's workers.
  jvmArgs =
      listOf(
